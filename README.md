...
| 대상 | 설치 | 직접 받기 |
|:--|:--|:--|
| **Windows** 데스크톱 | zip 압축 해제 후 실행 | [`comux-1.1.7-win-x64.zip`](https://github.com/Jeonghyeon-Ryu/Comux-Release/releases/download/v1.1.7/comux-1.1.7-win-x64.zip) |
| **Linux** 데스크톱 | `apt install comux` | [AppImage](https://github.com/Jeonghyeon-Ryu/Comux-Release/releases/download/v1.1.7/Comux-1.1.7.AppImage) · [.deb](https://github.com/Jeonghyeon-Ryu/Comux-Release/releases/download/v1.1.7/comux_1.1.7_amd64.deb) |
| **Linux** 서버 / SSH | 설치 스크립트 한 줄 | [`comux-tui-1.1.7-linux-x64.tar.gz`](https://github.com/Jeonghyeon-Ryu/Comux-Release/releases/download/v1.1.7/comux-tui-1.1.7-linux-x64.tar.gz) |
...
AppImage를 선호한다면 `chmod +x Comux-1.1.7.AppImage` 후 실행하세요.
...
**업데이트는 어떻게 확인하나요?**
새 릴리즈가 나오면 상태줄에 `⬆ 1.1.7 (^B u)` 배지가 뜹니다. `Ctrl+B u` 를 누르면 이 설치본(apt / install.sh)에 맞는 업그레이드 명령이 나옵니다. 셸에서는 `comux upgrade` 로도 확인할 수 있습니다.
